...
function TeaDetails({tea, home, sell}){
  ...
  return (
    <React.Fragment>
      <button onClick={home} className="py-2.5 px-5 mr-2 mb-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Back to List</button>
      <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h1 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{tea.name}</h1>
        <p className="font-normal text-gray-700 dark:text-gray-400">Origin: {tea.origin}</p>
        <p className="font-normal text-gray-700 dark:text-gray-400">Flavor: {tea.flavor}</p>
        <p className="font-normal text-gray-700 dark:text-gray-400">Price: {tea.price}</p>
        <p className="font-normal text-gray-700 dark:text-gray-400">Pounds sold: {tea.poundsSold} lb</p>
